...
import 'package:bundle_test/views/timecard/timecards_history.dart';
import 'package:bundle_test/views/transactions_history.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:get/get.dart';
import 'package:getwidget/getwidget.dart';

class Timecard_History_Card extends StatefulWidget {
  const Timecard_History_Card({Key? key}) : super(key: key);

  @override
  _Timecard_History_CardState createState() => _Timecard_History_CardState();
}

class _Timecard_History_CardState extends State<Timecard_History_Card> {
  @override
